                ...
                return Dismissible(
                  ...
                  confirmDismiss: (direction) async {
                    if (direction == DismissDirection.endToStart) {
                      final currentIndex =
                      cubit.donetask.indexWhere((t) => t['id'] == taskId);
                      if (currentIndex != -1) {
                        final removed = cubit.donetask.removeAt(currentIndex);

                        if (cubit.pinnedTasks.contains(taskId)) {
                          cubit.pinnedTasks.remove(taskId);
                          cubit.donetask.add(removed);
                        } else {
                          cubit.pinnedTasks.add(taskId);
                          cubit.donetask.insert(0, removed);
                        }
                  ...
                  onDismissed: (direction) {
                    if (direction == DismissDirection.startToEnd) {
                      ...
                      cubit.donetask.removeAt(removedIndex);
