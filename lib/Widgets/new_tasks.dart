                ...
                return Dismissible(
                  ...
                  confirmDismiss: (direction) async {
                    if (direction == DismissDirection.endToStart) {
                      ...
                      final currentIndex =
                      cubit.newtask.indexWhere((t) => t['id'] == taskId);
                      if (currentIndex != -1) {

                        final removed = cubit.newtask.removeAt(currentIndex);

                        if (cubit.pinnedTasks.contains(taskId)) {

                          cubit.pinnedTasks.remove(taskId);
                          cubit.newtask.add(removed);
                        } else {
                          cubit.pinnedTasks.add(taskId);
                          cubit.newtask.insert(0, removed);
                        }
                  ...
                  onDismissed: (direction) {
                    if (direction == DismissDirection.startToEnd) {
                      ...
                      cubit.newtask.removeAt(removedIndex);
